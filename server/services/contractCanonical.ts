...
export const MAPEOS_CANONICOS: Record<string, CATEGORIA_CANONICA> = {
    ...
    'densitometria': CATEGORIA_CANONICA.AMBULATORIO,
    'doppler': CATEGORIA_CANONICA.AMBULATORIO,
    'ecografia': CATEGORIA_CANONICA.AMBULATORIO,
    'ecotomografia': CATEGORIA_CANONICA.AMBULATORIO,
    'procedimientos': CATEGORIA_CANONICA.AMBULATORIO,
    'imagenologia': CATEGORIA_CANONICA.AMBULATORIO,
    'scanner': CATEGORIA_CANONICA.AMBULATORIO,
    'tac': CATEGORIA_CANONICA.AMBULATORIO,
    'resonancia': CATEGORIA_CANONICA.AMBULATORIO,
    'mamografia': CATEGORIA_CANONICA.AMBULATORIO,
    'rayos x': CATEGORIA_CANONICA.AMBULATORIO,
    'radiografia': CATEGORIA_CANONICA.AMBULATORIO,
    'biopsia': CATEGORIA_CANONICA.AMBULATORIO,
    'colonoscopia': CATEGORIA_CANONICA.AMBULATORIO,
    'endoscopia': CATEGORIA_CANONICA.AMBULATORIO,
    'kinesiologia': CATEGORIA_CANONICA.AMBULATORIO,
    'fonoaudiologia': CATEGORIA_CANONICA.AMBULATORIO,
    'terapias': CATEGORIA_CANONICA.AMBULATORIO,
    'dialisis': CATEGORIA_CANONICA.AMBULATORIO,
    'nutricionista': CATEGORIA_CANONICA.AMBULATORIO,
    'psicometria': CATEGORIA_CANONICA.AMBULATORIO,
    'telemedicina': CATEGORIA_CANONICA.AMBULATORIO,
    ...
    'citotoxicas': CATEGORIA_CANONICA.ONCOLOGIA,
    'oncologia': CATEGORIA_CANONICA.ONCOLOGIA,
    ...
    'optica': CATEGORIA_CANONICA.AMBULATORIO,
    'anteojos': CATEGORIA_CANONICA.AMBULATORIO,
    'lentes': CATEGORIA_CANONICA.AMBULATORIO,
    'audifonos': CATEGORIA_CANONICA.AMBULATORIO,
    'marcapaso': CATEGORIA_CANONICA.AMBULATORIO,
    'protesis': CATEGORIA_CANONICA.AMBULATORIO,
    'ortesis': CATEGORIA_CANONICA.AMBULATORIO,
