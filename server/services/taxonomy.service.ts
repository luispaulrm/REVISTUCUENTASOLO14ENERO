...
export class TaxonomyService {
    private static MEDICAL_KEYWORDS = /\b(INY|AMP|SOL|GRAG|TAB|CAPS|SUSP|MG|ML|UI|UG|MCG|MEQ|G|UNID|DOSIS|SACHET|SUERO|NATRECUR|PROPO|FENT|SEVO|CLORURO|POTASIO|SODIO|GLUCOSA|DESTROSA|CEFTRIAXONA|ATROPINA|HEPARINA|KETOPROFENO|LIDOCAINA|OMEPRAZOL|PROPOFOL|MIDAZOLAM|REMIFENTANIL)\b/i;

    private static MATERIAL_KEYWORDS = /\b(GASA|JERINGA|GUANTE|DRENAJE|SUTURA|SONDA|CATETER|EQUIPO.FLEBO|LLAVE.3.PASOS|BRANULA|DELANTAL|PAQUETE|SABANA|MANGA|FUNDA|ELECTRODO|PARCHE|BISTURI|TUBO.ENDOTRAQUEAL|ESTILETE|CANULA.MAYO|CIRCUITO.ANESTESIA|MASCARA.LARINGEA|FILTRO|ALUSA|BANDEJA|SET.ASEO|TERMOMETRO|CALZON|CONFORT|CEPILLO|AGUJA|CURACION|PROTECTOR|CLIP|TROCAR|ENDO.*BAG|GRAPA|MALLA|HEMOVAC|FOLEY|APOSITO|TAPA|ALARGADOR|SENSOR|OXISENSOR)\b/i;
