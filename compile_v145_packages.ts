...
// v1.4.5: Row Zone Policy Configuration
...
// v1.4.5: Header Band Policy for TEXT_ECHO promotion
...
// FIX 20: Detect and flag zones with exception text
...
function compilePackage(baseName: string, docTitle: string, page: number) {
    ...
    // 1. SPATIAL MAP HARDENING (v1.4.5)
    ...
    // FIX 20: Add has_conditions flag to zones with exception text
    ...
    // FIX 21: QC-Jurist now generates pseudo-zones for promoted ECHOs
    ...
    // Run geo report AFTER pseudo-zones are generated (they're merged in packager)
    ...
    fs.writeFileSync(`./audit_package_${baseName}_v1.4.5.json`, JSON.stringify(finalPackage, null, 2));
    console.log(`Saved audit_package_${baseName}_v1.4.5.json`);
